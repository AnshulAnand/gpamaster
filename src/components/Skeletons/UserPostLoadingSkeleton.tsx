const UserPostLoadingSkeleton = () => {
  return (
    <div
      role='status'
      className='space-y-8 animate-pulse md:space-y-0 md:space-x-8 rtl:space-x-reverse md:flex md:items-center w-full mt-4'
    >
      ...
      <div className='w-full'>
        ...
        <div className='h-2 rounded-full bg-gray-700 mb-2.5'></div>
        <div className='h-2 rounded-full bg-gray-700 mb-2.5'></div>
        <div className='h-2 rounded-full bg-gray-700 max-w-[560px]'></div>
      </div>
      <span className='sr-only'>Loading...</span>
    </div>
  )
}
export default UserPostLoadingSkeleton
